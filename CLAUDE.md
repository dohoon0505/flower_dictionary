...
온라인 꽃 배달 쇼핑몰을 운영하면서 직접 고객 상담을 책임지는 분을 위한 실전 응대 핸드북. 상담의 기초부터 상품 추천·배송·상품 문의·결제 환불·컴플레인·재구매·CS 도구까지 8개 챕터로 정리합니다. GitBook 스타일의 SPA + 통합 검색(Cmd/Ctrl+K) + 릴리즈 노트 페이지를 제공합니다.
